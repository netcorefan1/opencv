...
>>>>>>> e0435d3b8a871b54f9a78bb8662e47e47c36b05c
  )
  ...
  if(OPENCV_MODULE_${the_module}_CLASS STREQUAL "PUBLIC" AND
    ...
    ocv_install_target(${the_module} EXPORT OpenCVModules OPTIONAL
      ...
      LIBRARY DESTINATION bin${UNMANAGED_LIBRARY_OUTPUT_SUBFOLDER} COMPONENT libs NAMELINK_SKIP
      ARCHIVE DESTINATION ${OPENCV_LIB_INSTALL_PATH} COMPONENT dev
      )
  endif()
  if("${_target_type}" STREQUAL "SHARED_LIBRARY")
    install(TARGETS ${the_module}
      LIBRARY DESTINATION bin${UNMANAGED_LIBRARY_OUTPUT_SUBFOLDER} COMPONENT dev NAMELINK_ONLY)
  endif()
